            ...
            <div class="row justify-content-center">
                <div class="container">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <button class='btn btn-danger' id='btn3'>Cor 1</button>
                                <button class='btn btn-danger' id='btn4'>Cor 2</button>
                            </div>
                ...
                <center id='1'>
                    ...
                    <ul id="lista">
                        ...
                        ?>
                                <a style='text-decoration: none;' href='demonstrcaoOculos.html?id_arm=<?php echo($dados['id_arm']); ?>'class="item-lista">
                                    <li class="list-group-item blocoCard">
                                        <div class="card text-center" style="width: 220px;justify-content: center;display: flex;align-items: center;">
                                            <div class="cxImgOculos">
                                                <img
                                                src="adm/<?php echo($dados['foto_arm']); ?>"
                                                class="card-img-top" alt="fotoÓculos:<?php echo($dados['foto_arm']); ?>"
                                                style="height: 150px; width:150px;"
                                                />
                                            </div>
                                            <div class="card-body">
                                            <h5 class="card-title"><?php echo($dados['nome_arm']); ?></h5>
                                        </div>
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item txtCard">Material: <?php echo($dados['id_mat']); ?></li>
                                            <li class="list-group-item txtCard">Marca: <?php echo($dados['id_mar']); ?></li>
                                            <li class="list-group-item txtCard">Cor: <?php echo($dados['corPrincipal_arm']); ?></li>
                                            <li class="list-group-item txtCard">Cor secundária: <?php echo($dados['corSecund_arm']); ?></li>
                                        </ul>
                                        </div>
                                    </li> 
                                </a>
