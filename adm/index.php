...
<body class="p-3 mb-2 bg-dark">
    <nav class="navbar navbar-expand-lg navbar-danger bg-danger fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="..\index.html"><img src="../assets/outlet-dos-oculos-3.png" width="120" height="196" /></a>
            ...
            <form action="processaLogin.php" method="post">
                ...
                <div id="cxInput form-group">
                    <span class="d-block p-4 bg-light text-center">
                        ...
                        <input type="password" name="senha" id="senha" class="bg-muted text-dark form-control" />
                </div>
                <br>
                <center>
