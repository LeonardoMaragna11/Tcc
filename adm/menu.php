...
<body class="p-3 mb-2 bg-dark">
    <nav class="navbar navbar-expand-lg navbar-danger bg-danger fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand navbar-lg" href=""><img src="../assets/outlet-dos-oculos-3.png" width="120" height="196" /></a>
    ...
    <div>
        <h1 class="text-uppercase text-center text-white">Bem Vindo, <?php echo $user ?>
            <div align="center">
                <button class="btn btn-light text-danger"><a href="logout.php" class="text-danger"><b>SAIR</b></a></button>
                <button class="btn btn-light text-danger"><a href="mudarSenha.php?login=<?php echo($user); ?>" class="text-danger"><b>MUDAR SENHA</b></a></button>
            </div>
        </h1>
        <br>
    ...
    <div>
        <div id="novo-produto">
            <h2 class="text-uppercase text-white">NOVO PRODUTO</h2>
        </div>
        <div class="form-group">
            <span class="d-block p-4 bg-light ">
                <form action='processaOculos.php' method="POST" enctype="multipart/form-data">
                    ...
                    <input required type="text" name='nome_armacao' class="bg-muted text-dark form-control" placeholder='NOME DO PRODUTO' /><br>
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='preto' />
                        <label class="form-check-label" for="inlineCheckbox1">Preto</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='vermelho' />
                        <label class="form-check-label" for="inlineCheckbox1">Vermelho</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='amarelo' />
                        <label class="form-check-label" for="inlineCheckbox1">Amarelo</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='branco' />
                        <label class="form-check-label" for="inlineCheckbox1">Branco</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='azul' />
                        <label class="form-check-label" for="inlineCheckbox1">Azul</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corPrincipal" class="form-check-input" value='cinza' />
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='preto' />
                        <label class="form-check-label" for="inlineCheckbox1">Preto</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='vermelho' />
                        <label class="form-check-label" for="inlineCheckbox1">Vermelho</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='amarelo' />
                        <label class="form-check-label" for="inlineCheckbox1">Amarelo</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='branco' />
                        <label class="form-check-label" for="inlineCheckbox1">Branco</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='azul' />
                        <label class="form-check-label" for="inlineCheckbox1">Azul</label><br>
                    </div>

                    <div class="form-check form-check-inline">
                        <input type="radio" id="inlineCheckbox1" name="corSecondArmacao" class="form-check-input" value='cinza' />
                        <label class="form-check-label" for="inlineCheckbox1">Cinza</label><br>
                    </div>
                    <br><br><br>   
<center><div class=" container row col-4 custom-file bg-light-50 rounded">
    <span class="border border-danger rounded">
        <br>
    <label class="custom-file-label text-danger" for="foto_armacao"><b>SELECIONE UMA FOTO</b></label>
    <br>
    <hr class="bg-danger">
    <br>
    
    <input type="file" name='foto_armacao' 
           class="custom-file-input text-center" 
           id="validatedCustomFile" required>
           
    <div class="invalid-feedback">Selecione uma foto 1080x1080 em PNG ou JPEG</div>
    <br><br>
    </span>
                    ...
                    <span class="d-block p-4 bg-light text-center">
                        <form action="processaUser.php" method="post">
                            ...
                            <label for="nvSenha" class="text-danger"><b>Senha</b>
                                <input type="password" id='nvSenha' name='nvSenha' class="bg-muted text-dark form-control" />
                            </label>
                    </span>
                </div>
                    ...
                    <span class="d-block p-4 bg-light text-center">
                        <form action="processaMaterial.php" method="post">
                            <label for="nvMaterial" class="text-danger"><b>Material</b>
                                <input type="text" id='nvMaterial' name='nvMaterial' class="bg-muted text-dark form-control" />
                            </label>
                    </span>
                </div>
                <span class="d-block p-2 bg-light text-center">
                    ...
                    <span class="d-block p-4 bg-light text-center">
                        <form action="processaMarca.php" method="post">
                            <label for="nvMarca" class="text-danger"><b>Marca</b>
                                <input type="text" id='nvMarca' name='nvMarca' class="bg-muted text-dark form-control" />
                            </label>
                    </span>
                </div>
                <span class="d-block p-2 bg-light text-center">
                    ...
                    <span class="d-block p-4 bg-light text-center">
                        <form action="processaLoja.php" method="post">
                            ...
                            <label for="nvCep" class="text-danger"><b>CEP</b>
                                <input type="text" id='nvCep' name='nvCep' class="bg-muted text-dark form-control" placeholder="Ex.: 18000-000" />
                            </label>

                            <label for="nvEnd" class="text-danger"><b>Endereço</b>
                                <input type="text" id='nvEnd' name='nvEnd' class="bg-muted text-dark form-control" placeholder="Ex.: Rua ..., 315 - Vila ...." />
                            </label>

                            <label for="nvTel" class="text-danger"><b>Telefone</b>
                                <input type="text" id='nvTel' name='nvTel' class="bg-muted text-dark form-control" placeholder="Ex.: 15 991707070" />
                            </label>
                    </span>
                </div>
