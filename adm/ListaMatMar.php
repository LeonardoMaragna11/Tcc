...
<body class="text-center p-5 mb-2 bg-dark">
    <nav class="navbar navbar-expand-lg navbar-danger bg-danger fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href=""><img src="../assets/outlet-dos-oculos-3.png" width="120" height="196" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.php">Área de administradores</a></li>
                </ul>
            </div>
        </div>
    </nav>
            ...
            <div class="row justify-content-center">
                <div class="caixa col-10">
                    ...
                    <div>
                        ...
                        ?>
                                <div class='lista'>
                                    <p><span style="color: #DC3545">Nome Marca:</span> <?php echo ($marcas['nome_mar']); ?></p>
            ...
            <div class="row justify-content-center">
                <div class="caixa col-10">
                    ...
                    <div>
                        ...
                        ?>
                                <div class='lista'>
                                    <p><span style="color: #DC3545">Nome Material:</span> <?php echo ($material['nome_mat']); ?></p>
                ...
                <div class="caixa col-10">
                    ...
                    <div>
                        ...
                        ?>
                                <div class="lista">
                                    <p>
                                        <span style="color: #DC3545">Nome Loja:</span> <?php echo ($loja['nome_loj']) ?> <br>
                                        <span style="color: #DC3545">Cep Loja:</span> <?php echo ($loja['cep_loj']) ?> <br>
                                        <span style="color: #DC3545">Endereço Joja:</span> <?php echo ($loja['endereco_loj']) ?><br>
                                        <span style="color: #DC3545">Telefone Loja:</span> <?php echo ($loja['telefone_loj']) ?><br>
                                    </p>
                        ...
                        $i = 0;
                        ?><br><br>
                        <center><button class="btn btn-light text-danger"><a href="menu.php" class="text-danger"><b>VOLTAR</b></a></button></center>
                    </div>
                </div>
            </div>
        </div>
